...
- Same-device and cross-device flows for online authentication and authorization (OpenID4VP - draft 24) for remote authentication and authorisation
...
- An implementation of a credential issuing service, according to OpenId4VCI (draft 15) (provides test PID and mDL issuing service in mDoc and SD-JWT-VC format)
